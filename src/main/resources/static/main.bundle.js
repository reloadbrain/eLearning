...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__student_pre_exam_obligation_pre_exam_obligation_records_service__ = __webpack_require__("../../../../../src/app/student-pre-exam-obligation/pre-exam-obligation-records.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__pre_exam_o_type_pre_exam_o_type_component__ = __webpack_require__("../../../../../src/app/pre-exam-o-type/pre-exam-o-type.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__pre_exam_o_type_pre_exam_o_type_service__ = __webpack_require__("../../../../../src/app/pre-exam-o-type/pre-exam-o-type.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["NgModule"])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_24__pre_exam_o_type_pre_exam_o_type_component__["a" /* PreExamOTypeComponent */]
            ],
            imports: [
...
var PreExamOTypeComponent = /** @class */ (function () {
    ...
    PreExamOTypeComponent.prototype.getPreExamOTypes = function () {
        var _this = this;
        this.preExamOTypeService.getAll().subscribe(function (response) { return (_this.preExamOTypes = response.body, console.log(_this.preExamOTypes)); }, function (error) { return console.log(error); });
    };
    PreExamOTypeComponent.prototype.postNewType = function () {
        var _this = this;
...
var PreExamOTypeService = /** @class */ (function () {
    ...
    PreExamOTypeService.prototype.changeType = function (id) {
...
var StudentPreExamObligationComponent = /** @class */ (function () {
    ...
    StudentPreExamObligationComponent.prototype.getPreExamORecByUserIdAndCourseId = function (userId, courseId) {
        var _this = this;
        this.preExamObligationRecordsService.getAllByStudentAndCourse(this.userId, this.courseId).subscribe(function (response) { return (_this.preExamORecs = response.body, console.log(_this.preExamORecs)); }, function (error) { return console.log(error); });
    };
