...
var ProfessorExamRecordsComponent = /** @class */ (function () {
    ...
    ProfessorExamRecordsComponent.prototype.getPreExamPoints = function () {
        ...
        this.examRecords.forEach(function (element) {
            _this.pre.getPoints(element.studentId, element.courseId).subscribe(function (respnse) { return (element.preExamPoints = respnse.body, console.log(respnse)); }, function (error) { return console.log(error); });
        });
    };
    __decorate([
        core_1.Input(),
...
var PreExamObligationRecordsService = /** @class */ (function () {
    ...
    PreExamObligationRecordsService.prototype.getPoints = function (studentId, courseId) {
