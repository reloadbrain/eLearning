...
var PreExamObligationervice = /** @class */ (function () {
    ...
    PreExamObligationervice.prototype.setObligationDate = function (id, model) {
...
var ProfessorPreExamObligationComponent = /** @class */ (function () {
    ...
    ProfessorPreExamObligationComponent.prototype.onSetNewDate = function () {
        ...
        this.preExamObligationService.setObligationDate(this.newPreExamObligation.preExamOId, this.model).subscribe(function (error) { return console.log(error); });
    };
